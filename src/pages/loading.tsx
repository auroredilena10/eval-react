...
export default function Loading() {
    const title = "Loading...";
    const subtitle = "Please wait while we prepare everything for you";

    return (
        <div className="flex flex-col items-center justify-center dark:bg-gray-900 bg-white min-h-screen min-w-screen">
            ...
            <motion.div
                className="text-center space-y-4 max-w-64"
            ...
            >
                ...
                <motion.h1
                    className="text-lg/tight font-semibold text-black/90 dark:text-white/90 tracking-[-0.02em] leading-[1.15] antialiased"
                    initial={{ opacity: 0, y: 12 }}
                    animate={{
                        opacity: 1,
                        y: 0,
                ...
                <motion.p
                    className="text-base/relaxed text-black/60 dark:text-white/60 font-normal tracking-[-0.01em] leading-[1.45] antialiased"
